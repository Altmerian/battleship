  ...
  public handleMessage(client: ClientConnection, rawMessage: string): void {
    ...
    switch (parsedMessage.type) {
      case 'reg':
        ...
        responseService.sendToClient(client, 'reg', { name: 'test', index: '123', error: false, errorText: '' }, parsedMessage.id);
        break;
      ...
      default:
        ...
        responseService.sendError(client, `Unknown message type: ${parsedMessage.type}`, parsedMessage.type, parsedMessage.id);
        break;
    }
  }
}
